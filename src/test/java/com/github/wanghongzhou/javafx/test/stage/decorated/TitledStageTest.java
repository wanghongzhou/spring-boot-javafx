package com.github.wanghongzhou.javafx.test.stage.decorated;

import com.github.wanghongzhou.javafx.stage.decorated.TitledStage;
 ...
 * @author Brian
 */
public class TitledStageTest extends Application {

    @Override
    public void start(Stage primaryStage) {
        TitledStage stage = new TitledStage(primaryStage);
        ...
        stage.initStyle(DefaultStageStyle.UNDECORATED);
//        stage.setTheme(Objects.requireNonNull(getClass().getResource("/styles/blue.css")).toExternalForm());
        ...
        stage.setTitle("TitledStage Test");
        stage.setWidth(400);
        stage.setHeight(400);
        stage.show();
    }
    ...
    public static void main(String[] args) {
        Application.launch(TitledStageTest.class, args);
    }
}
